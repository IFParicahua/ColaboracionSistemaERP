...
<head>
	...
	<script type="text/javascript">
		function Start() {
            ...
            var comprobante = <?php echo $_GET['comprobante']?>;
			var report = new Stimulsoft.Report.StiReport();
			report.loadFile("reports/ComprobanteDetalle.mrt");

			report.dictionary.variables.getByName("idcomprobante").valueObject = +comprobante;
