...
@section('content')
    ...
    <div class="col-md-12">
        <div class="card strpied-tabled-with-hover">
            <h2 class="card-title">Balance General
            </h2>
                        ...
                        <script>
                            $(document).ready(function(){
                                $('#print').click(function () {
                                    ...
                                    if(moneda == "1") {
                                        javascript:window.open('http://localhost:8000/Reportes/RepBalanceGeneral/index.php?empresa='+empresa+'&gestion='+gestion+'&usuario='+usuario,'','width=900,height=500,left=50,top=50');
                                    }else{
                                        javascript:window.open('http://localhost:8000/Reportes/RepBalanceGeneral/indexAlt.php?empresa='+empresa+'&gestion='+gestion+'&usuario='+usuario,'','width=900,height=500,left=50,top=50');
                                    }

                                    // javascript:window.open('http://localhost:8000/Reportes/balancegeneral.php?gestion='+gestion+'&usuario='+usuario+'&empresa='+empresa,'','width=900,height=500,left=50,top=50');
                                })
                            });
                        </script>
                    </div>
