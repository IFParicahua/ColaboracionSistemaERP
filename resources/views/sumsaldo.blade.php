...
@section('content')
    ...
    <div class="col-md-12">
        <div class="card strpied-tabled-with-hover">
            <h2 class="card-title">Sumas y Saldos
            </h2>
                        ...
                        <script>
                            $(document).ready(function(){
                                $('#print').click(function () {
                                    ...
                                    var empresa = $('#emp').val();
                                    if(moneda == "1") {
                                        javascript:window.open('http://localhost:8000/Reportes/RepSumSaldos/indexprincipal.php?empresa='+empresa+'&gestion='+gestion+'&usuario='+usuario,'','width=900,height=500,left=50,top=50');
                                    }else{
                                        javascript:window.open('http://localhost:8000/Reportes/RepSumSaldos/indexalternativo.php?empresa='+empresa+'&gestion='+gestion+'&usuario='+usuario,'','width=900,height=500,left=50,top=50');
                                    }

                                    // javascript:window.open('http://localhost:8000/Reportes/sumsaldo.php?gestion='+gestion+'&usuario='+usuario+'&empresa='+empresa,'','width=900,height=500,left=50,top=50');
                                })
                            });
                        </script>
                    </div>
