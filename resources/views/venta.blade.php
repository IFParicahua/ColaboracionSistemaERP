        ...
        <div class="card strpied-tabled-with-hover">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-1">
                        <a id="btn_add" href="ventanew" name="btn_add" class="btn btn-primary btn-fill fa fa-plus"></a>
                    </div>
                    <div class="col-md-4">
                ...
                <table class="table table-hover table-striped">
                    ...
                    @forelse($notas as $nota)
                        <tr class="data-row">
                            ...
                            <td>
                                <a href="notaventa/{{$nota->id}}" class="btn btn-primary btn-fill fa fa-pencil"></a>
                            </td>
                        </tr>
